...
const getTranscript = async (req, res, next) => {
    try {
        ...
        const targetVideoId = videoId || (0, youtubeUtils_1.extractVideoId)(url);
        if (!targetVideoId) {
            return res.status(400).json({
                success: false,
        ...
        const transcript = await (0, youtubeUtils_1.getTranscriptByVideoId)(targetVideoId, lang, generateIfNotFound);
