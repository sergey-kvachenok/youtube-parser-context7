...
exports.getTranscriptByVideoId = exports.extractVideoId = void 0;
const youtube_transcript_1 = require("youtube-transcript");
const speechToTextUtils_1 = require("./speechToTextUtils");
/**
...
const getTranscriptByVideoId = async (videoId, lang = null, generateIfNotFound = true) => {
    try {
        ...
        const transcript = await youtube_transcript_1.YoutubeTranscript.fetchTranscript(videoId, options);
        ...
        if (error.message === 'No captions found' ||
            ...
            if (generateIfNotFound) {
                ...
                try {
                    ...
                    const generatedTranscript = await (0, speechToTextUtils_1.generateSubtitles)(videoId, lang || 'auto');
                    console.log(`Субтитры успешно сгенерированы для видео ${videoId}`);
                    // Добавляем флаг, что субтитры были сгенерированы
                    return generatedTranscript.map((item) => ({
                        ...item,
                        generated: true
                    }));
                }
...
exports.getTranscriptByVideoId = getTranscriptByVideoId;
